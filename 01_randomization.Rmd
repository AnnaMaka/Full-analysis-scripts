...
for i in range(1): #number adjusted for the target amount of participants
    ...
    pp = PdfPages('input_figs_' + str(r) +'.pdf')
    ...
    with open('psub'+str(r)+'_inputParam.json','w') as json_file:
...
```{python, warning=FALSE, results=FALSE}
#visualising restrictions of positions/movements
...
#circle6 = plt.Circle((objLoc[i][bounBound1][0], objLoc[i][bounBound1][2]), 9, color='orange', fill=False, alpha=0.5) #other objects cannot be inside of these circles
...
#circle7 = plt.Circle((objLoc[i][bounBound2][0], objLoc[i][bounBound2][2]), 9, color='orange', fill=False, alpha=0.5)
circle11 = plt.Circle((objLoc[i][bounBound2][0], objLoc[i][bounBound2][2]), 5, color='green', fill=False, alpha=0.5)
#circle8 = plt.Circle((objLoc[i][landBound1][0], objLoc[i][landBound1][2]), 9, color='orange', fill=False, alpha=0.5)
#circle9 = plt.Circle((objLoc[i][landBound2][0], objLoc[i][landBound2][2]), 9, color='orange', fill=False, alpha=0.5)
fig, ax = plt.subplots()
plt.xlim(-30,30)
plt.ylim(-30,30)
ax.set_aspect(1)
