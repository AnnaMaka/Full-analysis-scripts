...
Functions created for this analysis 
```{r functions}
...
Sum_angle will contain only columns related to angle estimation task.

```{r}
Sum_angle <- Sum_all %>% 
  select(ID, age, age_c, block, miniblock, mini, objectTrial, trial, cue, cueMM, object, sec2Beg, sec2Est, sec2End, secTrialEst, trialLen, 
