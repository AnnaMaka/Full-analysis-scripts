...
ggsave("relativeInfluenceAll.pdf", plot=relative_infl, units = "cm", width = 15.9, height = 7.3, dpi = "retina", device = cairo_pdf, path = here("figures"))
ggsave("relativeInfluenceAll.png", plot=relative_infl, units = "cm", width = 15.9, height = 7.3, dpi = "retina", device = "png", path = here("figures"))
...
tab_model(modelCue, modelCueAngle, show.p = FALSE, digits.re = 4,
          pred.labels = c("Intercept", "Cue"),  dv.labels = c("Positional Memory", "Pointing"), string.ci = "Conf. Int (95%)", 
          CSS = css_theme("cells")) 
```
...
ggsave("cueDiffAll.pdf", plot=cue_Diff, units = "cm", width = 15.9, height = 8.2, dpi = "retina", device = cairo_pdf, path = here("figures"))
ggsave("cueDiffAll.png", plot=cue_Diff, units = "cm", width = 15.9, height = 8.2, dpi = "retina", device = "png", path = here("figures"))
...
ggsave("RI_miniblocks.pdf", plot=g_miniblocks, units = "cm", width = 15.9, height = 14, dpi = "retina", device = cairo_pdf, path = here("figures"))
ggsave("RI_miniblocks.png", plot=g_miniblocks, units = "cm", width = 15.9, height = 14, dpi = "retina", device = "png", path = here("figures"))
...
tab_model(modelMiniblocksAngle, show.p = FALSE, digits.re = 4,
...
```{r}
tab_model(modelMiniblocksCue, modelMiniblocksAngle, show.p = FALSE, digits.re = 4,
          pred.labels = c("Intercept", "Cue", "Miniblock", "Interaction"),  
...
```{r}
tab_model(modelMiniblocksLandmark, modelMiniblocksBoundary, modelMiniblocksLandmarkAngle, modelMiniblocksBoundaryAngle, show.p = FALSE, digits.re = 4,
...
```{r}
tab_model(modelCueDis_mini, modelCueDis_miniA, show.p = FALSE, digits.re = 4,
          pred.labels = c("Intercept", "Cue", "Miniblock", "Interaction"),  
          dv.labels = c("Positional Memory", "Pointing"), 
          string.ci = "Conf. Int (95%)", 
          CSS = css_theme("cells")) 
...
Overview table with model for positional memory as well.

```{r}
tab_model(modelFull, modelFullAngle, show.p = FALSE, digits.re = 4,
          pred.labels = c("Intercept","Age", "Cue", "Interaction"),  dv.labels = c("Positional Memory", "Pointing"), string.ci = "Conf. Int (95%)", 
          CSS = css_theme("cells")) 
```
...
```{r}
tab_model(modelAgeLandmarkAngle, modelAgeBoundaryAngle, show.p = FALSE, digits.re = 4,
...
```{r}
tab_model(modelAgeLandmark, modelAgeBoundary, modelAgeLandmarkAngle, modelAgeBoundaryAngle, show.p = FALSE, digits.re = 4,
...
tab_model(modelCueDis_A, show.p = FALSE, digits.re = 4,
          pred.labels = c("Intercept", "Age", "Cue", "Interaction"),  dv.labels = "Cue Dissonance", string.ci = "Conf. Int (95%)", 
          CSS = css_theme("cells")) 
...
```{r}
tab_model(modelCueDis, modelCueDis_A, show.p = FALSE, digits.re = 4,
          pred.labels = c("Intercept","Age", "Cue", "Interaction"),  dv.labels = c("Positional Memory", "Pointing"), string.ci = "Conf. Int (95%)", 
          CSS = css_theme("cells")) 
```
