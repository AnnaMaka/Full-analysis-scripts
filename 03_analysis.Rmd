...
- average number of timeout trials per participant with timeout trials: `r round(nrow(timeout)/length(unique(timeout$ID)), 3)` 
- average number of timeout trials per participant: `r round(nrow(timeout)/length(subjects), 3)` 
